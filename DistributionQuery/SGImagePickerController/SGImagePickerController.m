...
- (instancetype)init{
    ...
    if (self = [super initWithRootViewController:self.assetsGroupVC]) {
        ...
        //导航条背景色
       // navBar.barTintColor = [UIColor colorWithRed:27/255.0 green:176/255.0 blue:229/255.0 alpha:1];
        [navBar setBackgroundImage:[UIImage imageNamed:@"nav"] forBarMetrics:3];
        //字体颜色
