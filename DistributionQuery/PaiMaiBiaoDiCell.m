...
@end
@implementation PaiMaiBiaoDiCell
...
+(instancetype)cellWithTableView:(UITableView*)tableView CellID:(NSString*)cellID{
    PaiMaiBiaoDiCell * cell =[tableView dequeueReusableCellWithIdentifier:cellID];
    if (!cell) {
        cell=[[PaiMaiBiaoDiCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
