...
@interface YuGaoXiangQingCell ()<TZImagePickerControllerDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate>
{
...
@implementation YuGaoXiangQingCell
...
+(instancetype)cellWithTableView:(UITableView*)tableView IndexPath:(NSIndexPath *)indexPath{
    ...
    YuGaoXiangQingCell * cell =[tableView dequeueReusableCellWithIdentifier:cellID];
    if (!cell) {
        cell=[[YuGaoXiangQingCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
...
-(void)CreatStar{
    ...
    [self.contentView sd_addSubviews:@[_leftLabel,_textview,_bgScrollview,_picContainerView]];
    ...
    .heightIs(20);
    [_leftLabel setSingleLineAutoResizeWithMaxWidth:ScreenWidth-30];
    _textview.sd_layout
...
{
    _imageArr=imageArr;
    _picContainerView.picPathStringsArray=imageArr;
}
